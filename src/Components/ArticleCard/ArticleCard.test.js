...
import {SavedProvider, SavedContext, value} from '../../Contexts/SavedContext'

describe('Article Card component', () => {
    // let contextValue: SavedProvider, dispatch: jest.Mock;
    beforeEach(() => {
    ...
    test('that dispatch is working', async() => {
        ...
        const saveButton = screen.getByAltText('save article')
        fireEvent.click(saveButton)
        expect(dispatch).toHaveBeenCalledWith(SavedContext.saveArticle)
    })
})